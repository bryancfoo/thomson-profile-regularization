...
Usage
-----
    python -m ThomsonScatteringArbitrary.thomson_forward path/to/deck.toml
    python -m ThomsonScatteringArbitrary.thomson_forward   # interactive prompt
...
See ``DECK_API.md`` in this directory for the full deck schema.
"""
