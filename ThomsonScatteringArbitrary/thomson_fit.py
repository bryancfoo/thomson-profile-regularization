...
Usage
-----
    python -m ThomsonScatteringArbitrary.thomson_fit path/to/deck.toml
    python -m ThomsonScatteringArbitrary.thomson_fit deck.toml --sample
    
    

The deck schema follows the standard sections consumed by
``ThomsonScatteringArbitrary.deck.build_settings_from_deck`` (``[data]``,
...
from ThomsonScatteringArbitrary.deck import (
    load_deck,
    build_settings_from_deck,
    save_fit_results,
)
from ThomsonScatteringArbitrary.fitting import run_fit_grad, compute_initial_fit, _build_grad_problem
...
def _run_l_curve_phase(Pkl_data, Pkl_var, meas, pen, pars, extras, constraints,
    ...
    """
    from ThomsonScatteringArbitrary.l_curve import compute_L_curve
