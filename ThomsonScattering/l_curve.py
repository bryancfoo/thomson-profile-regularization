...
Repeatedly calls :func:`ThomsonScattering.fitting.run_fit_grad` with the
...
def _fit_one_sweep_point(task, progress=False):
    ...
    :func:`ThomsonScattering.parallel.parallel_map`. Returns everything the
...
def compute_L_curve(
    ...
    *,
    ...
    n_workers : int or None, default None
        ...
        :func:`ThomsonScattering.parallel.default_n_workers`). The warm-start fit
